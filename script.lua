...
local function AdminCheck_Enable()
    ...
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            ...
            Icon = "rbxassetid://123471945613074" -- << ID Obrazka
        })
    end)
...
do -- Nowy 'do' block
	...
	CamoAnim.AnimationId = "rbxassetid://123471945613074";
...
do -- Use a 'do' block to scope variables specific to invisibility
    ...
    Animation.AnimationId = "rbxassetid://123471945613074"; -- Set AnimationId once
